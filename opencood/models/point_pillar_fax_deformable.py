...
from opencood.models.sub_modules.deformable_fusion import  \
    DeformFusionEncoder


class PointPillarFaxdeformable(nn.Module):
    def __init__(self, args):
        super(PointPillarFaxdeformable, self).__init__()
        ...
        self.fusion_net = DeformFusionEncoder(args['deformable_fusion'])
    ...
    def forward(self, data_dict):
        ...
        if self.training and self.args['da_training']:
            feature = []
            ...
            output_dict = {'psm': psm,
                        ...
                        'fused_feature': fused_feature,
                         'all_feature': spatial_features_2d}
