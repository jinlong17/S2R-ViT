...
from opencood.models.sub_modules.S2R_fusion import  \
    S2RFusionEncoder


class PointPillarS2Rformer(nn.Module):
    def __init__(self, args):
        super(PointPillarS2Rformer, self).__init__()
        ...
        self.fusion_net = S2RFusionEncoder(args['deformable_fusion'])
