...
class VoxelPreprocessor(BasePreprocessor):
    def __init__(self, preprocess_params, train):
        ...
        self.vw = self.params['args']['voxel_size'][0]
        self.vh = self.params['args']['voxel_size'][1]
        self.vd = self.params['args']['voxel_size'][2]
        self.T = self.params['args']['max_points_per_voxel']
